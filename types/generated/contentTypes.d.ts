...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'olio.order-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    paymentDetails: Schema.Attribute.Component<'olio.payment-details', false>;
    pickupTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
